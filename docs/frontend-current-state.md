...
- `SlotyPhoneNumberInput` uses the canonical customer-phone placeholder `01X XXX XXXX` as muted example text, never as a value. Entered phone values keep normal high-contrast text and existing E.164 normalization.
