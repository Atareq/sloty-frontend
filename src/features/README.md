...
Transaction history uses the shared two-arrow `ListSortControl` for Staff and Owner/Manager ledgers. Booking History does not expose that control until Backend server ordering exists.
